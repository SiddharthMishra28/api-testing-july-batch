...
public class DeserializationTwo {
...
//		mapper.configure(DeserializationFeature.EAGER_DESERIALIZER_FETCH, true);
		propertyList = mapper.readValue(response, new TypeReference<List<Property>>() {});
		System.out.println(propertyList);
		Property luxuryProperty = propertyList.get(1);
		System.out.println(luxuryProperty.getAddress());
	}
}
